                ...
                <div class="-mx-4 flex flex-wrap items-center">
                    <div class="w-full px-4">
                        <div class="text-center">
                            <h1 class="text-4xl font-semibold text-white" v-html="sanitizeHtml(data.title)" />
        ...
        <section class="relative md:py-20 py-16 uppercase">
            <div class="container">
                <div class="md:flex justify-center">
                    <div class="md:w-full">
                        <div id="printArea" class="p-6 bg-white rounded-md leading-7 html"
                            v-html="sanitizeHtml(page.content)" />
                        <div class="mt-2 p-6 bg-white rounded-md leading-7">
                            <span
                                class="bg-custom-dark border-primary w-full rounded border p-3 text-white transition hover:bg-opacity-90 cursor-pointer"
                                @click="print('printArea')">Print</span>
                        </div>
                    </div><!--end -->
                </div><!--end grid-->
            </div><!--end container-->
