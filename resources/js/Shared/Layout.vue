        ...
        <div class="md:flex md:flex-col">
            <div class="md:h-screen md:flex md:flex-col">
                <div class="md:flex md:shrink-0 ">
                    <div
                        class="md:shrink-0 md:py-2 md:w-60 flex items-center justify-between md:justify-center sidebar-left-top">
                        <Link class="mt-1" href="/">
                        <logo class="help-desk-logo" />
                        </Link>
                        <dropdown class=" md:hidden" class-name="small-menu" placement="bottom-end">
                            <template #default>
                                <svg class="w-6 h-6 mobile-menu-selector" xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 20 20">
                    ...
                    <div
                        ...
                        <div class="placement-top-left">
                            <div class="mt-1 welcome_text">
                                {{ generateGreetings() }} <span>{{
                            ...
                            <dropdown class="mt-1 rtl:ml-2 language_menu_wrapper" placement="bottom-end">
                                <template #default>
                                    <div class="flex items-center cursor-pointer group language_menu">
                                        <div class=" font-bold mr-1 rtl:mr-0 whitespace-nowrap w-[7rem]">
                                            <icon class="w-5 h-5" :name="selected_language.code" /> <span
                                                class="rtl:mr-[6px]">{{ selected_language.name }}</span>
                                        </div>
                                ...
                                <template #dropdown>
                                    <div class=" py-2 shadow-xl rounded text-sm language_menu_list">
                                        <Link v-for="language in languages_except_selected" :key="language.code"
                                            class="block px-6 py-2 hover:bg-indigo-500 hover:text-white"
                                            :href="route('language', [language.code])">
                                        <icon class="w-5 h-5" :name="language.code" /> <span
                                            class="lang_name rtl:mr-[6px]">{{ language.name }}</span>
                                        </Link>
                                    </div>
                                </template>
                            </dropdown>
                                ...
                                <template #default>
                                    <div class="flex items-center cursor-pointer group">
                                        <div class=" mr-1 whitespace-nowrap">
                                            <img v-if="$page.props.auth.user.photo" class="user_photo"
                                                :alt="$page.props.auth.user.first_name"
                                                :src="$page.props.auth.user.photo" />
                                            <img v-else src="/images/svg/profile.svg" class="w-5 h-5"
                                                alt="user profile" />
                                ...
                                <template #dropdown>
                                    <div class="shadow-xl bg-white rounded text-sm">
                                        ...
                                        <Link
                                            ...
                                            :href="route('logout')" method="delete" as="button">
                                        {{ __('Logout') }}
                                        </Link>
                                    </div>
                                </template>
                        ...
                        <div class="container-head">
                            <div class="ch-left">
                                ...
                                <div class="breadcrumb text-sm">
                                    ...
                                    <icon class="w-3 h-3" name="home" />
                                    </Link>
                                    <span class="b-item">/</span>
                                    <Link v-if="edit_route" :href="route(edit_route)" class="capitalize">
                                    {{ edit_route
                                    }}
                                    </Link>
                            ...
                            <div class="ch-right cursor-pointer">
                                <button id="theme-toggle" class="theme-toggle" title="Toggles light & dark"
                                    :aria-label="current_mode" aria-live="polite" @click="switchMode">
