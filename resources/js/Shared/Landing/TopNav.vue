                ...
                <div class="flex w-full items-center justify-between px-4">
                    <div>
                        <button id="navbarToggler"
                            ...
                            <span class="relative my-[6px] block h-[2px] w-[30px] bg-white" />
                            <span class="relative my-[6px] block h-[2px] w-[30px] bg-white" />
                            <span class="relative my-[6px] block h-[2px] w-[30px] bg-white" />
                        </button>
                                ...
                                <template #default>
                                    <div class="flex items-center cursor-pointer group">
                                        <div class=" mr-1 whitespace-nowrap text-white">
                                            ...
                                            <img v-else src="/images/svg/profile.svg" class="w-8 h-8"
                                                alt="user profile" />
                    ...
                    <div v-else class="hidden justify-end pr-16 sm:flex lg:pr-0">
                        <a :href="route('login')"
                            class="signUpBtn bg-transparent border border-white bg-opacity-20 py-2 px-6 text-base font-medium text-white duration-300 ease-in-out hover:bg-opacity-100 hover:bg-white hover:text-black">
                            Login
                        </a>
                    </div>
                </div>
